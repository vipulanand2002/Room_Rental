...
public class property2 extends AppCompatActivity {
    ImageButton beforeButton, afterButton;
    ImageSwitcher imageSwitcher;
    Button bookdeal;
    WebView webview1;
    int index= 0;int gorseller[] = {R.drawable.house2, R.drawable.house21, R.drawable.house22, R.drawable.house23, R.drawable.house24, R.drawable.house25};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_property2);
