...
public class property5 extends AppCompatActivity {
    ImageButton beforeButton, afterButton;
    ImageSwitcher imageSwitcher;
    Button bookdeal;
    WebView webview1;
    int index= 0;int gorseller[] = {R.drawable.house5,R.drawable.house51, R.drawable.house52, R.drawable.house53, R.drawable.house54, R.drawable.house55};


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_property5);
