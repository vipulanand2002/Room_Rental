...
public class property3 extends AppCompatActivity {
    ImageButton beforeButton, afterButton;
    ImageSwitcher imageSwitcher;
    Button bookdeal;
    WebView webview1;
    int index= 0;int gorseller[] = {R.drawable.house3, R.drawable.house31,R.drawable.house32, R.drawable.house33, R.drawable.house34, R.drawable.house35, R.drawable.house36,};
