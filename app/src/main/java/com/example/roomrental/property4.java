...
public class property4 extends AppCompatActivity {
    ImageButton beforeButton, afterButton;
    ImageSwitcher imageSwitcher;
    Button bookdeal;
    WebView webview1;
    int index= 0;int gorseller[] = {R.drawable.house4,R.drawable.house41, R.drawable.house42, R.drawable.house43, R.drawable.house44, R.drawable.house45,R.drawable.house46};


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_property4);
